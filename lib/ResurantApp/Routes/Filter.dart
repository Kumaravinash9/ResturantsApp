...
class _FilterState extends State<Filter> {
  ...
  Widget build(BuildContext context) {
    ...
    body: Column(
          ...
          children:<Widget> [
           SizedBox(height:15),
          Text("Adjust your meal Selection",style: TextStyle(
        fontSize: 22,fontWeight: FontWeight.w900,
      ),),
     

      SwitchListTile(value: vegetarian, onChanged:(newValue){
      setState(() {
       vegetarian=newValue;
      });},
     ...
     subtitle: Text("Only include "+"Vegetarian".toLowerCase()+" meals."),
     ),
      ...
      Padding(
       ...
       SwitchListTile(value: vegan, onChanged:(newValue){
      setState(() {
      vegan=newValue;});},
     ...
     subtitle: Text("Only include "+"Vegan".toLowerCase()+" meals."),
      ...
      SwitchListTile(value: lactose_free, onChanged:(newValue){
     setState(() {
   ...
   subtitle: Text("Only include "+"Lactose-Free".toLowerCase()+" meals."),
   ),
       ...
       SwitchListTile(value: gluten_free, onChanged:(newValue){
     setState(() {
      gluten_free=newValue;
     }); },title: Text("Gluten-Free",style: TextStyle(
     fontWeight: FontWeight.w500,fontSize: 20),),
     subtitle: Text("Only include "+"Gluten-Free".toLowerCase()+" meals."),
     ),
      ],
    ),
    );

...
@override
  void didChangeDependencies() {
    routeAgrs=ModalRoute.of(context).settings.arguments as Map<String,Object>;
    meals =widget.dummy_data.where((e)=>e.categories.contains(routeAgrs['id']) ).toList();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: meals.length==0?Center(child:Text(" Sorry! no item is avaible ")):
